// importa tudo da biblioteca yup
...
class UserController {
  async store(req, res) {
    // YUP define o formato dos dados recebidos do body
  ...
  // PERMITE QUE O USUÁRIO FAÇA ATUALIZAÇÕES NO CADASTRO
  async update(req, res) {
    const schema = Yup.object().shape({
      ...
      password: Yup.string()
        .min(6)
        .wenn('oldPassword', (oldPassword, field) =>
